...
<template>
  <div
    ...
    :data-chart="chartId"
    :class="cn(
      `[&_.tick_text]:!fill-muted-foreground [&_.tick_line]:!stroke-border/50 flex flex-col justify-center text-xs w-full [&_[data-vis-xy-container]]:w-full [&_[data-vis-single-container]]:w-full overflow-hidden`,
      props.class,
    )"
    :style="{
